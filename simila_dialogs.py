...
class Simila_dialogs():
    def __init__(self, screenObject, simila, using_win):
        ...
        self.dialog_rect_1 = pygame.Rect(self.dialog_rect.x, self.dialog_rect.y, self.dialog_rect.w // 2, self.dialog_rect.h // 2)
        self.dialog_rect_2 = pygame.Rect(self.dialog_rect.centerx, self.dialog_rect.y, self.dialog_rect.w // 2, self.dialog_rect.h // 2)
        self.dialog_rect_3 = pygame.Rect(self.dialog_rect.x, self.dialog_rect.centery, self.dialog_rect.w // 2, self.dialog_rect.h // 2)
        self.dialog_rect_4 = pygame.Rect(self.dialog_rect.centerx, self.dialog_rect.centery, self.dialog_rect.w // 2, self.dialog_rect.h // 2)
    ...
    def check_mouse_pos_for_options(self):
        if self.dialog_state != None:
            ...
            if self.dialog_rect_1.left <= self.mouse_pos[0] <= self.dialog_rect_1.right and self.dialog_rect_1.top <= self.mouse_pos[1] <= self.dialog_rect_1.bottom:
                self.option = '_1'
            elif self.dialog_rect_2.left <= self.mouse_pos[0] <= self.dialog_rect_2.right and self.dialog_rect_2.top <= self.mouse_pos[1] <= self.dialog_rect_2.bottom:
                self.option = '_2'
            elif self.dialog_rect_3.left <= self.mouse_pos[0] <= self.dialog_rect_3.right and self.dialog_rect_3.top <= self.mouse_pos[1] <= self.dialog_rect_3.bottom:
                self.option = '_3'
            elif self.dialog_rect_4.left <= self.mouse_pos[0] <= self.dialog_rect_4.right and self.dialog_rect_4.top <= self.mouse_pos[1] <= self.dialog_rect_4.bottom:
                self.option = '_4'
            else:
                self.option = ''
