...
class Dialog():
    ...
    def update_dialog(self):
        match self.dialog_phase:
            ...
            case 'simila_greetings': self.screenObject.screen.blit(self.simila_greetings, self.rect)
            case 'game_offer': self.screenObject.screen.blit(self.game_offer, self.rect)
